...
def evaluate(model_path: str, episodes: int = 100, grid_size: int = 20, state_mode: str = "basic17", seed: int = 3000):
    ...
    if not os.path.exists(model_path):
        ...
        print("请先运行训练: python train_sb3_dqn.py --timesteps 200000")
        sys.exit(1)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="评估 SB3 DQN 模型")
    parser.add_argument("--model", type=str, default="checkpoints/sb3_dqn_snake.zip", help="模型路径")
